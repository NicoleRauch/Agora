...
export default (props) => (
  <div>
    ...
    <BootstrapTable data={props.data} striped={true} hover={true} condensed={true} search={true}>
      ...
      <TableHeaderColumn dataSort={true} dataField='homeAddressLines'>Heimatadresse</TableHeaderColumn>
      <TableHeaderColumn dataSort={true} dataField='billingAddressLines'>Rechnungsadresse</TableHeaderColumn>
